...
// import Footer from '../components/footer/Compact.svelte';

// Simple footer: no big sample
// import Footer from '../components/footer/Simple.svelte';

// Empty footer: only buttons
// import Footer from '../components/footer/Empty.svelte';
