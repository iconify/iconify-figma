...
(() => {
    ...
    describe('Testing views manager', () => {
        ...
        it('create view from route with parent, navigate to home', done => {
            ...
            // Set API data
            api.setFakeData('collections', {}, JSON.parse(fs.readFileSync(__dirname + '/fixtures/collections.json', 'utf8')));
            api.setFakeData('collection', apiParams('fa-regular'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/fa-regular.json', 'utf8')));
        ...
        it('home, then 2 collections', done => {
            let instance = customSearch({}),
                ...
                events = instance.get('events'),
                counter = 0,
                views, collection1, collection2, collections;
            ...
            // Delay by 300ms
            api.setFakeData('collection', apiParams('ant-design'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/ant-design.json', 'utf8')), 300);
        ...
        it('home and immediately load collection', done => {
            ...
            api.setFakeData('collection', apiParams('fa-regular'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/fa-regular.json', 'utf8')), 10);
        ...
        it('home and immediately load 2 collections', done => {
            ...
            api.setFakeData('collections', {}, JSON.parse(fs.readFileSync(__dirname + '/fixtures/collections.json', 'utf8')), 10);
            api.setFakeData('collection', apiParams('fa-regular'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/fa-regular.json', 'utf8')), 10);
            api.setFakeData('collection', apiParams('ant-design'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/ant-design.json', 'utf8')), 10);
        ...
        it('updating current view', done => {
            ...
            // Set API data
            api.setFakeData('collections', {}, JSON.parse(fs.readFileSync(__dirname + '/fixtures/collections.json', 'utf8')));
            api.setFakeData('collection', apiParams('fa-regular'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/fa-regular.json', 'utf8')), 50);
