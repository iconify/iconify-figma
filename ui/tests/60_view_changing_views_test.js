...
(() => {
    ...
    describe('Testing actions that change views', () => {
        ...
        it('searching from collections list', done => {
            ...
            // Set API data
            api.setFakeData('collections', {}, JSON.parse(fs.readFileSync(__dirname + '/fixtures/collections.json', 'utf8')), 100);
        ...
        it('collection from search results', done => {
            ...
            // Set API data
            api.setFakeData('collection', apiParams('ant-design'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/ant-design.json', 'utf8')));
            api.setFakeData('collection', apiParams('el'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/el.json', 'utf8')));
            api.setFakeData('search', {
                query: 'home',
                limit: 64
            }, JSON.parse(fs.readFileSync(__dirname + '/fixtures/search-home.json', 'utf8')));
        ...
        it('search from search results', done => {
            ...
            api.setFakeData('search', {
                query: 'nav',
                limit: 64
            }, JSON.parse(fs.readFileSync(__dirname + '/fixtures/search-nav.json', 'utf8')));
            api.setFakeData('search', {
                query: 'qwerty',
                limit: 64
            }, JSON.parse(fs.readFileSync(__dirname + '/fixtures/search-qwerty.json', 'utf8')));
