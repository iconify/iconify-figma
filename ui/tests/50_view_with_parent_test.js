    ...
    describe('Testing view with parent view', () => {
        ...
        it('collections -> collection', done => {
            ...
            events.subscribe('view-loaded', view => {
                if (view === collections) {
                    ...
                    collection = collectionView(instance, {
                        prefix: 'fa-regular'
                    }, collections);
        ...
        it('collection -> custom', done => {
            ...
            events.subscribe('load-history', callback => {
                callback(['ic:baseline-call', 'ic:outline-call', 'ic:round-call', 'ic:sharp-call']);
            });
        ...
        it('wrong loading order', done => {
            ...
            api.setFakeData('collection', apiParams('fa-regular'), JSON.parse(fs.readFileSync(__dirname + '/fixtures/fa-regular.json', 'utf8')), 0);
