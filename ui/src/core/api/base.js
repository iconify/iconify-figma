...
module.exports = instance => {
    let api = {
        ...
        load: (query, params, callback, options) => {
            options = Object.assign({}, api._defaultOptions, typeof options === 'object' ? options : {});

            let cacheKey = options.cacheKey === null ? api.cacheKey(query, params) : options.cacheKey;
         ...
         * @private
         */
        _appendToURI: (uri, key, value) => uri + (uri.indexOf('?') !== -1 ? '&' : '?') + key + '=' + encodeURIComponent(value)
    };
