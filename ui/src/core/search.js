...
let Search = {
	...
	normalizeParams: params => {
		...
		params.prefixes =
			!params.prefix &&
			params.prefixes instanceof Array &&
			params.prefixes.length
				? params.prefixes.slice(0)
				: null;
	},
	...
	init: params => {
		...
		let instance = {
			...
			namespace:
				typeof params.namespace === 'string' ? params.namespace : 'iconify',
			...
			get: name => {
				if (instance._data[name] === void 0) {
					instance._data[name] =
						Search[name] === void 0 ? null : Search[name](instance);
				}
	...
	setup: instance => {
		...
		if (
			typeof instance.params.query === 'string' &&
			instance.params.query.length
		) {
