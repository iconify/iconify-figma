...
class Views {
    ...
    home() {
        ...
        if (this._app.params && typeof this._app.params.prefix === 'string') {
            ...
            this._view = this.createView('collection', {
    ...
    isHome(view) {
        ...
        if (this._app.params && typeof this._app.params.prefix === 'string') {
            return view.type === 'collection' && view.prefix === this._app.params.prefix;
        } else {
    ...
    _homeOnFail(view) {
        ...
        // Subscribe to event
        this._events.subscribe('view-loaded', loadedView => {
            if (loadedView !== view) {
                return;
            }
            // Success!
    ...
    _fromRoute(route) {
        ...
        return this.createView(route.type, {
