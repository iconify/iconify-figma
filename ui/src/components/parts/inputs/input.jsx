...
class Input extends Component {
    constructor(props) {
        ...
        let value = typeof props.value === 'string' || typeof props.value === 'number' ? '' + props.value : '';
    ...
    render() {
        let props = this._getProps(),
            ...
            className = 'plugin-input' + (typeof props.className === 'string' ? ' ' + props.className : ''),
            wrapperClassName = 'plugin-input-wrapper' + (typeof props.wrapperClassName === 'string' ? ' ' + props.wrapperClassName : ''),
            resetButton = null,
            icon = null,
