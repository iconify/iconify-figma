		...
		props.samples.forEach((sample, index) => {
			...
			samples.push(
				<span
					className="iconify"
					data-inline="false"
					data-icon={(props.prefix ? props.prefix + ':' : '') + sample}
					key={sample}
				/>
			);
		});
	...
	return (
		<div
			className={
				...
				(props.index
					? ' plugin-collections-item--' + (props.index % maxIndex)
					: '') +
				(props.prefix ? ' plugin-collections-item--' + props.prefix : '')
			}
		>
			...
			<div className="plugin-collections-data">
				...
				{props.height && (
					<div className="plugin-collections-data-height">
						<IconHeight
							text={
								'' +
				...
				{props.total && (
					<div className="plugin-collections-data-total">
						<IconHeight text={'' + props.total} />
					</div>
				)}
			</div>
		</div>
