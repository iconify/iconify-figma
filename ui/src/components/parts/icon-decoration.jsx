...
function Arrows() {
	return (
		<path
			fill="currentColor"
			fillRule="nonzero"
			d="M5.5 0l3 3-1 1L6 2.5v7L7.5 8l1 1-3 3-3-3 1-1L5 9.5v-7L3.5 4l-1-1z"
		/>
	);
}
	...
	switch (name) {
		...
		case 'layout-grid':
			return (
				...
				>
					<path
						fill="currentColor"
						d="M2 2h2v2H2zM6 2h2v2H6zM10 2h2v2h-2zM2 6h2v2H2zM6 6h2v2H6zM10 6h2v2h-2zM2 10h2v2H2zM6 10h2v2H6zM10 10h2v2h-2z"
					/>
				</svg>
			);
			...
			return (
				...
				>
					<path
						stroke="currentColor"
						fill="none"
						d="M1 2.5h14M1 7.5h14M1 12.5h14"
					/>
				</svg>
			);
		...
		case 'angle':
			return (
				...
				>
					<path
						d="M2 2v8h8V9H7a4 4 0 00-4-4V2H2zm1 4v3h3a3 3 0 00-3-3z"
						fill="currentColor"
						fillRule="evenodd"
					/>
				</svg>
		...
		case 'check':
			return (
				...
				>
					<path
						clipRule="evenodd"
						d="m13.2069 5.20724-5.50002 5.49996-.70711.7072-.70711-.7072-3-2.99996 1.41422-1.41421 2.29289 2.29289 4.79293-4.79289z"
						fill="currentColor"
						fillRule="evenodd"
					/>
				</svg>
		...
		case 'layer-frame':
			return (
				...
				>
					<path
						d="M2.5 13.5h11m-11 5h11m-8-8v11m5-11v11"
						fill="none"
